...
export class MyToken extends OP20 {
    ...
    public override onDeployment(_calldata: Calldata): void {
        const maxSupply: u256 = u256.fromString('2100000000000000'); // 21 million with 8 decimals
        const decimals: u8 = 8; // Your decimals.
        const name: string = 'Farm coin'; // Your token name.
        const symbol: string = 'farm'; // Your token symbol.
